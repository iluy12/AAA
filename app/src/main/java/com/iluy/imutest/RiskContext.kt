...
object RiskContext {
     ...
     *
     * ⚠️ הטווחים גסים בכוונה — השאלה מציעה חלקי-יום, ואין טעם להעמיד
     * פנים שיש כאן דיוק של שעה.
     *
     * ⚠️ **אבל הם חייבים לכסות את כל 24 השעות.** קודם היו שלושה טווחים
     * בלבד, ו-18:00 עד 21:59 לא נכללו באף אחד — כלומר האות היה מכובה
     * בארבע השעות שבהן שתיים משלוש הנפילות הראשונות שנמדדו קרו. חור
     * בכיסוי אינו "אין מידע", הוא **תשובה שלילית שגויה**.
     */
