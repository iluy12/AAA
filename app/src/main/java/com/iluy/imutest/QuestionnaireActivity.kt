    ...
    private fun renderStep() {
        ...
        when (step) {
            0 -> renderMultiChoice(
                ...
                // ⚠️ **"ערב" נוסף אחרי שהנתונים חשפו חור של ארבע שעות.**
                // בוקר נגמר ב-11, צהריים ב-17, ולילה מתחיל ב-22 — כלומר
                // 18:00 עד 21:59 לא היו שייכות לשום תשובה אפשרית. שתיים
                // משלוש הנפילות האמיתיות של 2026-08-02 קרו שם (18:30
                // ו-20:50), ולכן **לא הייתה שום דרך לענות נכון על השאלה.**
                listOf("בוקר", "צהריים", "ערב", "לילה"),
